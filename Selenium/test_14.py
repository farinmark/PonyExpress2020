...
from included_in_consolidation import enter_object_number
from included_in_consolidation import check_colour
...
8) В поле «Ввод данных» ввести текст «99-9999-9999/999» и нажать Enter - 
